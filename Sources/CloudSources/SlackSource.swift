...
extension SlackSource: AskScanning { public func recentAsks(enabled: Set<BucketID>?, scan: AskScan) async throws -> [Ask] { try await scanAsks(enabled: enabled, scan: scan) } }
