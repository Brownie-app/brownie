...
public enum BrainEngine: String, CaseIterable, Sendable {
    case openai, anthropic, openrouter, custom, none
    ...
    public var keyName: String? {
        switch self { case .openai: return "OPENAI_API_KEY"; case .anthropic: return "ANTHROPIC_API_KEY"; case .openrouter: return "OPENROUTER_API_KEY"; case .custom: return "CUSTOM_BRAIN_API_KEY"; case .none: return nil }
    }
    public var defaultModel: String {
        switch self { case .openai: return "gpt-5.6-luna"; case .anthropic: return "claude-opus-5"; case .openrouter: return "anthropic/claude-opus-5"; case .custom: return "local"; case .none: return "" }
    }
}
...
public enum BrainFactory {
    ...
    public static func hasKey(_ e: BrainEngine) -> Bool { e.keyName.flatMap(Secrets.value).map { !$0.isEmpty } ?? (e == .custom) }
}
