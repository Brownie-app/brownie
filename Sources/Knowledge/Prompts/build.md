...
- `README.md` — the portrait: who this person is, their work, the people who matter, what is going on in their life right now. About 200 words, never more than 350. Everything else hangs off this.
...
`README.md` is the portrait: who the user is in at most 350 words — their name, what they do and where, who matters to them and why, what is live this month — written to them in the second person ("You are…", "Your…"). It is never a table of contents, a description of the vault's folders or a guide to using it.
